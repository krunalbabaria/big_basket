...
class InventoriesControllerTest < ActionController::TestCase
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post :create, inventory: { description: @inventory.description, name: @inventory.name, price: @inventory.price, qty: @inventory.qty }
    end
  ...
  test "should update inventory" do
    patch :update, id: @inventory, inventory: { description: @inventory.description, name: @inventory.name, price: @inventory.price, qty: @inventory.qty }
    assert_redirected_to inventory_path(assigns(:inventory))
  end
